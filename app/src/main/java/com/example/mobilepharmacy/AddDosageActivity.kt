...
class AddDosageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonZapisz.setOnClickListener {
            ...
            if (nazwaProduktu.isEmpty()) {
                ...
                else if (((capacity.text.toString().toDoubleOrNull() ?: 0.0) > 99.0) || ((dosageAmount.text.toString().toDoubleOrNull()?:0.0)> 5)) {
                    Toast.makeText(this, "Wprowadzona liczba jest za duża", Toast.LENGTH_SHORT)
                        .show()
                }
                    else {
    ...
    private fun visibleFromDC(capacity: Any?, expirationDate: Any?, dosageAmount: Any?) {
        ...
        val textWatcher = object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                // Po zmianie tekstu
                val capacity = s.toString().toDoubleOrNull()?:0.0
                if (capacity < 0) {
        ...
        firestoreDB.collection("leki")
            ...
            .addOnSuccessListener { querySnapshot ->
                if (querySnapshot.isEmpty) {
                    ...
                    val dosageAmountNumber = dosageAmount.toDoubleOrNull() ?: 0
                    dataMap["email"] = email
                    ...
                    if (newOld) {
                        ...
                        if (dosage != null) {
                            ...
                            if ((capacityNumber != iloscTabletekNumber) || !identical || (dosageAmount != dosageAmountActual)) {
